...
class Game:
    def __init__(self):
        ...
        self.surface = pygame.display.set_mode((1080, 480))
    ...
    def play(self):
        ...
        if not (0 <= self.snake.x[0] <= 1080 and 0 <= self.snake.y[0] <= 480):
            raise CollisionError
    ...
    def show_game_over(self):
        ...
        self.surface.blit(line1, (350, 160))
        line2 = font.render("To play again press Enter. To exit press Escape!", True, (255, 255, 255))
        self.surface.blit(line2, (280, 230))
